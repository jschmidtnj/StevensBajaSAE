...
void loop() // run over and over again
{
  ...
  if (millis() - timer > 10) {
    ...
    */
    ...
    Serial.println("asdf" + "," + String(rpm_data, num_decimal) + "," + speed_gps + "," + thermocouple_1_data + "," + thermocouple_2_data + "," + latitude + "," + longitude + "," + altitude_gps + "," );
  }
};
//MAX6675 thermocouple_2(thermoCLK_2, thermoCS_2, thermoDO_2);
String thermocouple_2_data = "0";
...
void loop() // run over and over again
{
  ...
  if (millis() - timer > 10) {
    ...
    */
    ...
    Serial.println(String(rpm_data, num_decimal) + "," + speed_gps + "," + thermocouple_1_data + "," + thermocouple_2_data + "," + latitude + "," + longitude + "," + altitude_gps + "," );
  }
};
//MAX6675 thermocouple_2(thermoCLK_2, thermoCS_2, thermoDO_2);
String thermocouple_2_data = "0";
