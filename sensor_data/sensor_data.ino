...
void loop() // run over and over again
{
  ...
  // approximately every 500 milliseconds or so, print out the current stats - can't really do lower or it doesn't work
  if (millis() - timer > delay_print) {
